use crate::{
  ...
  emitter::{SeparatedEmitter, TooManyEmitter, UnexpectedTrailingSeparatorEmitter},
  error::{syntax::MissingSyntaxOf, token::UnexpectedTokenOf},
  input::{Cursor, InputRef},
  parser::{
    AllowLeading, Maximum,
...
impl<'inp, 'closure, Sep, O, L, Ctx, Lang: ?Sized, Cmpl: crate::input::Completeness>
  EndStateHandler<'inp, 'closure, Sep, O, L, Ctx, Lang, Cmpl> for AllowLeading<Maximum>
where
  L: Lexer<'inp>,
...
impl<'inp, 'closure, Sep, O, L, Ctx, Lang: ?Sized, Cmpl: crate::input::Completeness>
  ContinueStateHandler<'inp, 'closure, Sep, O, L, Ctx, Lang, Cmpl> for AllowLeading<Maximum>
where
  L: Lexer<'inp>,
  Ctx: ParseContext<'inp, L, Lang>,
...
impl<'inp, 'closure, Sep, O, L, Ctx, Lang: ?Sized, Cmpl: crate::input::Completeness>
  SeparatorStateHandler<'inp, 'closure, Sep, O, L, Ctx, Lang, Cmpl> for AllowLeading<Maximum>
where
  L: Lexer<'inp>,
  Ctx: ParseContext<'inp, L, Lang>,
  Ctx::Emitter: SeparatedEmitter<'inp, L, Lang>,
