...
/// # impl Token<'_> for Digit { type Kind = Kind; type Error = Infallible; const SCAN_LOOKAHEAD: tokora::ScanLookahead = tokora::ScanLookahead::Unbounded; fn kind(&self) -> Kind { Kind } fn is_trivia(&self) -> bool { false } }
